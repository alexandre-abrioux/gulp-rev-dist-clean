...
Keep the original revised files? \[yes/no\] (cf. [How It Works](#how-it-works) for an example)
...
Keep the original files generated by [gulp-rev](https://github.com/sindresorhus/gulp-rev)? \[yes/no\] (cf. [How It Works](#how-it-works) for an example)
